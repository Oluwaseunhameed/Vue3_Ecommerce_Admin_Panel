    ...
    <div class="card-body space-y-6 p-6">
      <form @submit.prevent="onSubmit" class="space-y-6">
        ...
        <div>
          ...
          <button type="button" @click="values.attributes.push({id: uuid(), name:'', value:''})" class="px-4 py-2 rounded bg-primary text-(--primary) hover:bg-(--primary-soft) flex items-center gap-2 cursor-pointer">
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <button type="button" @click="isVariantModalOpen = true" class="px-4 py-2 rounded bg-primary text-(--primary) hover:bg-(--primary-soft) flex items-center gap-2 cursor-pointer">
        ...
        <div class="flex justify-end gap-4 mt-6">
          ...
          <button type="submit" class="px-5 py-3 rounded bg-primary text-(--primary) hover:bg-(--primary-soft) text-base cursor-pointer">Save Draft</button>
          <button type="submit" class="px-5 py-3 rounded bg-success text-(--primary) hover:bg-(--primary-soft)/90 text-base cursor-pointer">Publish</button>
        </div>
